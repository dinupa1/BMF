...
\includegraphics[width=10.0cm]{imgs/spectrometer.pdf}
...
\begin{Pic}{6.0}{(2., 2.)}
\includegraphics[width=6.cm]{imgs/opt_2D.png}
...
\begin{Pic}{6.0}{(9., 2.)}
\includegraphics[width=6.cm]{imgs/loss2D.png}
