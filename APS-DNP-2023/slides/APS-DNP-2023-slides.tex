...
\begin{frame}
\frametitle{Internal Structure of the Proton}

\begin{Pic}{3.}{(0.5, 2.0)}
  \includegraphics[width=3.cm]{imgs/proton3.png}
\end{Pic}
...
\begin{Pic}{4.}{(0.0, 8.)}
  \includegraphics[width=4.cm]{imgs/dynamic_proton.png}
\end{Pic}
...
%   \includegraphics[width=6.cm]{imgs/true_fit_0.png}
% \end{Pic}
%
% \begin{Pic}{5.}{(0.5, 8.5)}
%   \caption{Detector level}
%   \includegraphics[width=5.cm]{imgs/reco_fit_0.png}
% \end{Pic}
%
% \begin{Pic}{8.}{(7., 2.)}
%   \caption{Unfolded}
%   \includegraphics[width=8.cm]{imgs/pred_fit_0.png}
% \end{Pic}
% \end{frame}
