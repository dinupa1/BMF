...
train_tree = uproot.open("R2_mc.root:Train_xF3")
...
# test histograms
test_tree = uproot.open("R2_mc.root:Test_xF3")

test_hist = test_tree["hist"].array().to_numpy()
test_label = test_tree.arrays(["lambda", "mu", "nu"], library="pd").to_numpy()
...
score = r2_score(test_label, output, multioutput='raw_values')
